...
void Display::show() {
    ...
    for (auto *p: philosophers) {
        std::string state;
        switch (p->getState()) {
            case Philosopher::State::Thinking: state = "Thinking";
                break;
            case Philosopher::State::Hungry: state = "Hungry";
                break;
            case Philosopher::State::Ordering: state = "Ordering";
                break;
            case Philosopher::State::Waiting: state = "Waiting";
                break;
            case Philosopher::State::Eating: state = "Eating";
                break;
            case Philosopher::State::Paying: state = "Paying";
                break;
